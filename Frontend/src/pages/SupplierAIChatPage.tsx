...
import {
  ...
  Zap, ChevronLeft, ChevronRight, Layers, ShoppingCart, Tag, BadgeDollarSign,
...
export default function SupplierAIChatPage() {
  ...
  const [sidebarTab, setSidebarTab] = useState<"inv">("inv");
          ...
          >
            <GlassCard interactive={false} className="flex flex-col h-full p-0 overflow-hidden card-shadow">
              <div className="flex items-center gap-2 border-b border-border px-3 py-3 shrink-0">
                <History className="h-4 w-4 text-orange-500 shrink-0" />
                  ...
                  chatSessions.map((s) => (
                    <div
                      ...
                      className={`group relative flex flex-col px-3 py-2 mx-1 rounded-lg cursor-pointer transition-colors hover:bg-secondary/70 ${
                        currentSessionId === s.session_id ? "bg-orange-500/10 hover:bg-orange-500/15" : ""
                      }`}
