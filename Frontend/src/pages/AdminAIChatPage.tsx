          ...
          <form className="flex items-center gap-2" onSubmit={(e) => { e.preventDefault(); handleSend(); }}>
            ...
            {voice.isPreviewing && (
              <>
                ...
                <div className="flex-1 flex items-center rounded-2xl border border-violet-500/30 bg-violet-500/5 px-3 py-1 focus-within:border-violet-500/50 transition-colors min-w-0">
